...
### Git state
- Commit terakhir terkait: `ee7a609` (CP 6 agama → KEPKA BKPDM 020/2026), `7068ceb` (gap buku SD/SMA diisi via `fill_gap_books.js`), `df3c033` (peta bab SMA → materi_inti), `cd818dc` (fallback CP_FULL Fase E → IPA/IPS), `b4d43d7` (peta bab & data IPAS SD), `6a5b4fb` (SMA Tingkat Lanjut), `09450fc` (peta bab SMP). Semua sudah di-push ke origin/main.
