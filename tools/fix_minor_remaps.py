"""fix_minor_remaps.py – Fix minor element name mismatches.

Subjects & mappings:
  PAI:           "Al-Qur'an dan Hadis" -> "Al-Qur'an Hadis"
  IPS:           "Pemahaman Konsep IPS" -> "Pemahaman IPS"
  Prakarya:      "Desain/Perencanaan" -> "Perencanaan"
"""
import json
...
ELEMENT_MAP = {
    "Al-Qur'an dan Hadis": "Al-Qur'an Hadis",
    "Pemahaman Konsep IPS": "Pemahaman IPS",
    "Desain/Perencanaan": "Perencanaan",
}
